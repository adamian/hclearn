...
# Luke Diabled as no longer required! -> manually set place cells    
#    # TODO for resizable
#    def setXY(self, x, y):
#        if x==3 and y==3:
#            self.placeId=0
...
# Luke Disabled as no longer used! -> Manually set place cells       
...
#        return center+d
    ...
    # TODO for resizable
#    def getGrids(self): # Luke mdified to receive the x,y instead of the place cell id
